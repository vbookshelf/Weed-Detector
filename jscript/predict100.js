...
(async function () {
	...
	model = await tf.loadModel('http://plant.test.woza.work/plant_model_v1/model.json');
	$("#selected-image").attr("src", "http://plant.test.woza.work/assets/charlock.jpg")
...
$("#predict-button").click(async function () {
	...
	let top5 = Array.from(predictions)
		...
		}).slice(0, 5); // adjust the number of output predictions here.
